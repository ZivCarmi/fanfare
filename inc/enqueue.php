...
function fanfare_styles() {
    ...
    if (is_front_page()) {
	...
	} else if (is_page_template('pages/terms.php')) {
		wp_enqueue_style('terms-style', TEMPLATE_DIRECTORY_URI . '/css/terms.css' . FILES_VERSION, []);
		...
		wp_enqueue_style('lightbox-css', TEMPLATE_DIRECTORY_URI . '/css/lightbox.css' . FILES_VERSION, []);
		wp_enqueue_script('single-work-script', TEMPLATE_DIRECTORY_URI . '/js/single-work.js' . FILES_VERSION, ['jquery', 'swiper-js'], null, true);
		...
		wp_enqueue_script('product-script', TEMPLATE_DIRECTORY_URI . '/js/product.js' . FILES_VERSION, ['jquery', 'swiper-js'], null, true);
	} else if (is_cart()) {
		...
		wp_enqueue_style('checkout-style', TEMPLATE_DIRECTORY_URI . '/css/checkout.css' . FILES_VERSION, []);
		wp_enqueue_script('checkout-script', TEMPLATE_DIRECTORY_URI . '/js/checkout.js' . FILES_VERSION, ['jquery'], null, true);
	}
