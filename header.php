...
<html <?php language_attributes(); ?> class="dark">
	...
	<body <?php body_class('bg-background text-primary-foreground group'); ?>>

		<?php wp_body_open(); ?>

		<header id="site-header" class="container pt-6 lg:fixed lg:top-0 lg:left-0 lg:right-0">
			<div id="site-navigation" class="fixed z-50 inset-0 bg-primary text-primary-foreground hidden lg:block lg:relative lg:bg-transparent">
			...
			<div class="mobile-menu container relative z-[51] lg:hidden">
				<div class="flex items-center justify-between">
					<?php get_template_part('/template-parts/logo', null, ['path_class' => 'group-[.popover-active]:fill-primary-foreground']); ?>
